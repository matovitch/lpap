    ...
    def test_upsert_stores_comment_and_config_json(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            upsert_run(
                ...
                metadata={"comment": "C=256 energy-bank surrogate", "pinned": False},
            )
            record = load_run_record(path, run_id="surrogate_c256:demo")
            self.assertEqual(record["comment"], "C=256 energy-bank surrogate")
            ...
            self.assertEqual(comment, "C=256 energy-bank surrogate")
