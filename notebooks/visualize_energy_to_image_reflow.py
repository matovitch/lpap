...
def _():
    ...
    from lpap.visualization_notebook import render_energy_to_image_reflow_run_gallery
...
def _(mo):
    mo.md("""
    # Energy-to-image reflow visualization
    """)
    return
...
def _(
    ...
    config = default_energy_to_image_reflow_training_config()
    ...
    if run_options:
        ...
        run_picker = mo.ui.dropdown(
            options={"No energy-to-image reflow runs": ""},
            value="No energy-to-image reflow runs",
            label="Run",
            disabled=True,
        )
...
def _(
    ...
    if not active_run_id:
        output = mo.md("No energy-to-image reflow runs have been logged yet.")
    else:
        ...
        try:
            ...
            gallery = mo.md(f"Energy-to-image reflow gallery unavailable: `{error}`")
        output = mo.vstack(
            [
                mo.md(
